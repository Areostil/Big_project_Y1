...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($id_projet) || empty($nom_projet) || empty($description_projet) || empty($image_projet)) {
    ...
    $stmt = $bdd->prepare("UPDATE projets SET name = :nom_projet, resume = :description_projet, img = :image_projet WHERE id = :id_projet");
...
<body style="background: rgb(17,18,20);">
    ...
    <h1 id="h1_ajouter_projet" style="text-align: center;margin-left: 0px;margin-top: 40px;"><span style="color: rgb(255, 255, 255);">Modifier un projet</span></h1>
